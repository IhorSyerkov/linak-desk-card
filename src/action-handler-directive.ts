...
customElements.define('action-handler-linak-desk', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-linak-desk')) {
    return body.querySelector('action-handler-linak-desk') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-linak-desk');
